...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ["var(--font-inter)", "Plus Jakarta Sans", "Inter", "system-ui", "-apple-system", "sans-serif"],
        display: ["var(--font-outfit)", "Outfit", "Plus Jakarta Sans", "system-ui", "-apple-system", "sans-serif"],
      },
      boxShadow: {
