...
export default function HeroExperience() {
  ...
  // Typography entrance variants (100ms stagger as requested)
  const lineVariants = {
          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            <div>
              ...
              >
                ...
                <span className="text-[10px] sm:text-[11px] uppercase tracking-[0.25em] text-cream/75 font-mono">
            ...
            >
              ...
              <a
                href="#destinations"
                className="border border-cream/25 hover:border-cream text-cream hover:bg-white/[0.04] min-h-[50px] px-7 py-3.5 rounded-none text-[11px] uppercase tracking-[0.18em] font-medium text-center transition-all inline-flex items-center justify-center gap-2.5 backdrop-blur-sm"
              >
