  ...
  return (
    <section id="process" className="relative py-20 lg:py-28 overflow-hidden bg-slate-950/40 border-t border-b border-white/[0.06]">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div>
                <div className="flex items-center justify-between gap-3 mb-5">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-2.5 py-0.5">
                      {step.tag}
                    </span>
                  </div>
                  <div className="flex items-center gap-1.5 text-xs text-slate-400 font-medium bg-slate-950/60 border border-white/[0.06] rounded-lg px-2.5 py-1">
        ...
        {/* CTA Bar */}
        <div className="mt-14 rounded-3xl border border-emerald-500/30 bg-gradient-to-r from-emerald-950/40 via-slate-900/90 to-blue-950/40 p-6 sm:p-8 backdrop-blur-xl flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <a
            href="#booking"
            className="flex-shrink-0 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 px-6 py-3.5 text-xs sm:text-sm font-bold text-white shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 hover:scale-[1.02] transition-all"
          >
