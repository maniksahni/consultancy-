      ...
      {expanded && (
        <div className="animate-slide-up-fade w-72 sm:w-80 rounded-2xl border border-emerald-500/30 bg-slate-900/95 backdrop-blur-xl shadow-2xl shadow-black/70 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-blue-600 px-4 py-3.5 flex items-center gap-3">
            {/* Mentor Monogram Avatar */}
            <div className="h-10 w-10 rounded-full border-2 border-white/40 flex-shrink-0 bg-slate-950 flex items-center justify-center text-white">
              <Compass className="h-5 w-5 text-emerald-400" />
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5">
                <p className="text-sm font-bold text-white">Personal Mentor</p>
                <span className="text-[10px] bg-white/20 text-white rounded-full px-1.5 py-0.2">Online</span>
                {/* Online indicator */}
              ...
              <div className="flex items-center gap-1.5 text-[11px] text-emerald-100">
                ...
                <span>Active now — Direct 1-on-1 guidance</span>
              </div>
            </div>
            <button
          ...
          <div className="p-4 space-y-3">
            <div className="flex gap-2.5">
              <div className="h-7 w-7 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex-shrink-0 mt-0.5 flex items-center justify-center text-emerald-400">
                <Compass className="h-4 w-4" />
              </div>
              <div className="flex-1 bg-slate-800/90 rounded-2xl rounded-tl-sm px-3.5 py-3">
                <p className="text-xs text-slate-200 leading-relaxed">
                  👋 Hi! I&apos;m your Senior Study-Abroad Mentor.
                </p>
                <p className="text-xs text-slate-300 mt-1.5 leading-relaxed">
                  Ask me about <strong className="text-white">university shortlisting</strong>, <strong className="text-white">SOP review</strong>, or <strong className="text-white">visa interview prep</strong>. You talk directly with me 1-on-1!
                </p>
        ...
        {!expanded && (
          <div className="absolute right-full mr-3 animate-slide-up-fade">
            <div className="flex items-center gap-2 rounded-xl bg-slate-900/95 border border-emerald-500/30 backdrop-blur-xl px-3.5 py-2 shadow-xl whitespace-nowrap">
              ...
              <span className="text-xs font-semibold text-white">Chat with Senior Mentor</span>
